...
{
    NSString *path = [NSString stringWithFormat:@"%@/%@", textSecureDirectoryAPI, @"internal/account/invitation"];
    return [TSRequest requestWithUrl:[NSURL URLWithString:path]
                              method:@"POST"
...
{
    NSString *path = [NSString stringWithFormat:@"%@/%@/%@", textSecureAccountsAPI, @"invitation", inviteCode];
    return [TSRequest requestWithUrl:[NSURL URLWithString:path]
                              method:@"GET"
                          parameters:@{}
            ];
...
+ (TSRequest *)profileAvatarUploadUrlRequest:(nullable NSString *)recipientNumber
{
    ...
    if (recipientNumber) {
        path = [NSString stringWithFormat:@"%@/%@", textSecureProfileAvatarUrl, recipientNumber];
    }
    else {
        path = textSecureProfileAvatarUrl;
    }
