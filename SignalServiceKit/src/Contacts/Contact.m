...
- (instancetype)initWithFullName:(NSString *)fullName phoneNumber:(NSString *)number
{
    ...
    _parsedPhoneNumbers = [self parsedPhoneNumbersFromUserTextPhoneNumbers:_userTextPhoneNumbers
                                                        phoneNumberNameMap:_phoneNumberNameMap];
...
+ (CNContact *)mergeCNContact:(CNContact *)oldCNContact newCNContact:(CNContact *)newCNContact
{
    ...
    // TODO: maybe reconstract this contacts without system contacts.
