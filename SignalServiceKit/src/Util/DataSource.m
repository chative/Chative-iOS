...
@property (nonatomic) NSDictionary<NSString *, id> *pickedInfo;
...
+ (nullable DataSource *)dataSourceWithPickedInfo:(NSDictionary<NSString *, id> *)pickedInfo
{
    OWSAssert(pickedInfo);
    
    if (!pickedInfo) {
        return nil;
    }
    
    NSURL *videoURL = pickedInfo[UIImagePickerControllerMediaURL];
    ...
    DataSourcePath *instance = [DataSourcePath new];
    instance.filePath = videoURL.path;
    instance.pickedInfo = pickedInfo;
    return instance;
}
