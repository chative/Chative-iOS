...
@property (strong) NSString* atPersons;
@end
...
@dynamic contact;
- (BOOL) hasAtPersons {
  return !!hasAtPersons_;
}
- (void) setHasAtPersons:(BOOL) _value_ {
  hasAtPersons_ = !!_value_;
}
@synthesize atPersons;
- (instancetype) init {
  if ((self = [super init])) {
    self.body = @"";
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasAtPersons) {
    [output writeString:10 value:self.atPersons];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasAtPersons) {
    size_ += computeStringSize(10, self.atPersons);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasAtPersons) {
    [output appendFormat:@"%@%@: %@\n", indent, @"atPersons", self.atPersons];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasAtPersons) {
    [dictionary setObject: self.atPersons forKey: @"atPersons"];
  }
  [self.unknownFields storeInDictionary:dictionary];
}
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasAtPersons == otherMessage.hasAtPersons &&
      (!self.hasAtPersons || [self.atPersons isEqual:otherMessage.atPersons]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  __block NSUInteger hashCode = 7;
  ...
  if (self.hasAtPersons) {
    hashCode = hashCode * 31 + [self.atPersons hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (OWSSignalServiceProtosDataMessageBuilder*) mergeFrom:(OWSSignalServiceProtosDataMessage*) other {
  ...
  if (other.hasAtPersons) {
    [self setAtPersons:other.atPersons];
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
...
- (OWSSignalServiceProtosDataMessageBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 82: {
        [self setAtPersons:[input readString]];
        break;
      }
    }
  }
...
- (BOOL) hasAtPersons {
  return resultDataMessage.hasAtPersons;
}
- (NSString*) atPersons {
  return resultDataMessage.atPersons;
}
- (OWSSignalServiceProtosDataMessageBuilder*) setAtPersons:(NSString*) value {
  resultDataMessage.hasAtPersons = YES;
  resultDataMessage.atPersons = value;
  return self;
}
- (OWSSignalServiceProtosDataMessageBuilder*) clearAtPersons {
  resultDataMessage.hasAtPersons = NO;
  resultDataMessage.atPersons = @"";
  return self;
}
@end
