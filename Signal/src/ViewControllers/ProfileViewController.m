...
- (void)createViews
{
    ...
    infoRow.userInteractionEnabled = NO;
    // modified:  do not jump to the signal.org website when tapping the profile
//    [infoRow
    ...
    [self presentViewController:alertController
                     ...
                     completion:^{
                         [OWSProfileManager.sharedManager updateLocalProfileName:normalizedProfileName
                             ...
                             success:^{
                                 // added: add userself to contact list.
                                 Contact * newContact = [[Contact alloc] initWithFullName:normalizedProfileName
                                                                              phoneNumber:[TSAccountManager localNumber]];
                                 [[Environment current].contactsManager addUnknownContact:newContact addSuccess:nil];
