...
+ (void)sendTextMessageInThread:(TSThread *)thread counter:(NSUInteger)counter
{
    ...
    [ThreadUtil sendMessageWithText:text atPersons:@"" inThread:thread quotedReplyModel:nil messageSender:messageSender];
...
+ (void)createNewGroups:(NSUInteger)counter recipientId:(NSString *)recipientId
{
    ...
    TSOutgoingMessage *message =
        [TSOutgoingMessage outgoingMessageInThread:thread groupMetaMessage:TSGroupMessageNew atPersons:nil expiresInSeconds:0];
                               ...
                               transaction:(YapDatabaseReadWriteTransaction *)transaction
{
    ...
    for (NSUInteger i =0; i < count; i++) {
        ...
        TSOutgoingMessage *message = [TSOutgoingMessage outgoingMessageInThread:thread
                                                                    messageBody:text
                                                                      atPersons:@"insertAndDeleteNewOutgoingMessages"
                                                                   attachmentId:nil
                          ...
                          transaction:(YapDatabaseReadWriteTransaction *)initialTransaction
{
    ...
    for (NSUInteger i =0; i < count; i++) {
        ...
        TSOutgoingMessage *message = [TSOutgoingMessage outgoingMessageInThread:thread
                                                                    messageBody:text
                                                                      atPersons:@"resurrectNewOutgoingMessages1"
                                                                   attachmentId:nil
                                                               expiresInSeconds:expiresInSeconds];
    ...
    for (NSUInteger i =0; i < count; i++) {
        ...
        TSOutgoingMessage *message = [[TSOutgoingMessage alloc]
            initOutgoingMessageWithTimestamp:[NSDate ows_millisecondTimeStamp]
                                    inThread:thread
                                 messageBody:text
                                      atPersons:@"resurrectNewOutgoingMessages2"
            ...
            NSString *randomText = [self randomText];
            {
                TSIncomingMessage *message =
                    [[TSIncomingMessage alloc] initIncomingMessageWithTimestamp:timestamp.unsignedLongLongValue
                                                                 ...
                                                                 sourceDeviceId:0
                                                                    messageBody:randomText
                                                                      atPersons:@"createTimestampMessagesInThread"
                                                                  attachmentIds:[NSMutableArray new]
                                                               expiresInSeconds:0
                                                                  quotedMessage:nil
                                                                   contactShare:nil];
                                     ...
                                     transaction:(YapDatabaseReadWriteTransaction *)transaction
{
    ...
    TSOutgoingMessage *message =
        [[TSOutgoingMessage alloc] initOutgoingMessageWithTimestamp:[NSDate ows_millisecondTimeStamp]
                                                           inThread:thread
                                                        messageBody:messageBody
                                                          atPersons:@"createFakeOutgoingMessage"
