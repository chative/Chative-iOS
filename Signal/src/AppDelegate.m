...
//                [AppStoreRating setupRatingLibrary];
    ...
    if ( !OWSScreenLock.sharedManager.isScreenLockEnabled || (bScreenLockDone&&OWSScreenLock.sharedManager.isScreenLockEnabled)) {
...
- (void)clearAllNotificationsAndRestoreBadgeCount
{
    ...
    // modified: do not modify badge count.
//    [AppReadiness runNowOrWhenAppIsReady:^{
...
- (void)ensureRootViewController
{
    ...
    if ([TSAccountManager isRegistered]) {
        ...
        homeView.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"我的" image:[UIImage imageNamed:@"tabbar_Chative"] tag:0];
        SignalsNavigationController *homeNavController =
        [[SignalsNavigationController alloc] initWithRootViewController:homeView];
        
        // 联系人
        NewContactThreadViewController *contactVC = [NewContactThreadViewController new];
        contactVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"通讯录" image:[UIImage imageNamed:@"tabbar_contact"] tag:1];
        ...
        settingVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"我的" image:[UIImage imageNamed:@"tabbar_me"] tag:2];
        OWSNavigationController *settingNavController =
        [[OWSNavigationController alloc] initWithRootViewController:settingVC];

        
        DFTabbarController *tabbarVC = [DFTabbarController new];
        ...
        // show invitation view, user can switch to registeration view in this view
        InviteRegistrationViewController *viewController = [InviteRegistrationViewController new];
