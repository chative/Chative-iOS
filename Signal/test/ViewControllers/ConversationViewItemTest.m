...
- (ConversationViewItem *)textViewItem
{
    ...
    [TSOutgoingMessage outgoingMessageInThread:nil messageBody:self.fakeTextMessageText atPersons:@"textViewItem" attachmentId:nil];
    [message save];
...
- (ConversationViewItem *)viewItemWithAttachmentMimetype:(NSString *)mimeType filename:(NSString *)filename
{
    ...
    [attachment save];
    TSOutgoingMessage *message =
    [TSOutgoingMessage outgoingMessageInThread:nil messageBody:nil atPersons:nil attachmentId:attachment.uniqueId];
    [message save];
